...
$sql = "SELECT * FROM paket_liburan WHERE id_paket = $id_paket";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($paket == "Jelajah Kilat") {
        $harga = 2000000 * $jumlah;
    } elseif ($paket == "Jelajah Santai") {
    ...
    if (mysqli_query($koneksi, $sql)) {
        echo "<script>alert('Data berhasil diperbarui'); window.location='modifikasi.php';</script>";
    } else {
        echo "<script>alert('Data gagal diperbarui'); window.location='edit_paket.php?id=$id_paket';</script>";
    }
}
?>
    ...
    <div class="container">
      ...
      <form class="search-form" method="post">
            ...
            <div class="form-group text-left">
              <label>Alamat</label>
                <div class="input-group">
                  <input type="textarea" class="form-control" name="alamat" value="<?php echo htmlspecialchars($data['alamat']); ?>" required>
                </div>
            </div>
            <div class="form-group text-left">
              <label>Peserta</label>
            ...
            <div class="form-group text-left">
              <label>Paket Liburan</label>
                <select class="form-control" name="paket" required>
                  ...
                  <option value="Jelajah Kilat" <?php echo ($data['paket'] == 'Jelajah Kilat') ? 'selected' : ''; ?>>Jelajah Kilat</option>
                  <option value="Jelajah Santai" <?php echo ($data['paket'] == 'Jelajah Santai') ? 'selected' : ''; ?>>Jelajah Santai</option>
                  <option value="Jelajah Eksplorasi" <?php echo ($data['paket'] == 'Jelajah Eksplorasi') ? 'selected' : ''; ?>>Jelajah Eksplorasi</option>
                </select>
            </div>
            <div class="form-group">
                <button class="button border-0 mt-3" type="submit" name="submit">Ubah</button>
            </div>
        </form>
      </div>
    </div>
