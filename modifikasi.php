<?php
include "koneksi.php";
$paket_liburan=query("SELECT * FROM paket_liburan");
...
$totalQuery = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM paket_liburan $whereClause");
$totalData = mysqli_fetch_assoc($totalQuery)['total'];
$totalPages = ceil($totalData / $limit);
$query = "SELECT * FROM paket_liburan $whereClause LIMIT $start, $limit";
$paket_liburan = query($query);
    ...
    <div class="container">
      ...
      <div class="table-responsive">
        <table class="table table-hover table-custom">
          ...
          <tbody>
            <?php if (!empty($paket_liburan)): ?>
            <?php $id=1; ?>
            <?php foreach ($paket_liburan as $row): ?>
              <tr>
                <td><?php echo $id; ?></td>
                ...
                <td>
                  <a href="edit_paket.php?id=<?php echo $row['id_paket']; ?>" class="btn btn-icon btn-warning"><i class="fas fa-edit"></i></a>
                  <a href="hapus_paket.php?id=<?php echo $row['id_paket']; ?>" class="btn btn-icon btn-danger" onclick="return confirmDelete();"><i class="fas fa-trash-alt"></i></a>                </td>
                </tr>
            <?php $id++; ?>
            <?php endforeach; ?>
            <?php else: ?>
